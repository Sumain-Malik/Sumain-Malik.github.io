// SET BIRTHDAY DATE
const birthday = new Date("February 19, 2026 00:00:00").getTime();
...
const memes = [
    "https://www.youtube.com/shorts/KyQ6VeywlSI",
    "https://www.youtube.com/shorts/oCwUxkA_jXQ",
    "https://www.youtube.com/shorts/1ylKV2yuIyQ",
...
const memeMessages = [
    ...
    "Classic laugh — share with a friend! 😂",
    "Almost there — one more laugh coming up! 😜",
    "Final day special — Happy Birthday! 🎂🎉"
];
...
const interval = setInterval(() => {
    ...
    if (days <= 3 && days >= 0) {
        ...
        memeEl.innerHTML = `
            <h2>Daily Meme Surprise 😂</h2>
            <p class="meme-message">${messageText}</p>
            <p><a href="${watchUrl}" target="_blank" rel="noopener noreferrer">Click for instant giggles 🤣</a></p>
        `;
    }
